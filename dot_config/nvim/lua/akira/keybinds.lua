...
map("n", "<Leader>bd", "<cmd>lua MiniBufremove.wipeout()<CR>", { desc = "[D]elete Current Buffer" })
...
map("n", "<Leader>pr", "<cmd>Pick oldfiles<CR>", { desc = "[Mini.pick] Pick Oldfiles" })
map("n", "<Leader>pg", "<cmd>Pick grep_live<CR>", { desc = "[Mini.pick] Pick Grep" })
map("n", "<Leader>pd", "<cmd>Pick diagnostic<CR>", { desc = "[Mini.pick] Pick Diagnostics" })
